-- updating: check before if the file is empty
...
-- inserting
COPY covid_countries FROM '/home/gtrindadi/covid-19/data/covid-19-insert.csv' (FORMAT csv);
COPY covid_countries FROM '/home/gtrindadi/covid-19/data/covid-19-today.csv' (FORMAT csv);